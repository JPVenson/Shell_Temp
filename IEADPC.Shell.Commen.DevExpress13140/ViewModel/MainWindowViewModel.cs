...
namespace IEADPC.Shell.Commen.DevExpress13140.ViewModel
{
    ...
    public class MainWindowViewModel : ViewModelBase, IRemoteApplicationViewService
    {
                                                   ...
                                                   NotifyCollectionChangedEventArgs notifyCollectionChangedEventArgs)
        {
            ...
            System.Windows.Application.Current.MainWindow.TaskbarItemInfo.Description = Title;
        }
        ...
        private class LowLevelInstanceWrapper : IRibbonModuleAreaProvider
        {
            private readonly IVisualService _service;
            ...
            {
                _service.OnStart(application);
            }

            #endregion

            #region Implementation of IVisualService

            public object View { get { return _service.View; } }
            public object ViewModel { get { return _service.ViewModel; } }

            public bool OnEnter()
            {
                return _service.OnEnter();
            }

            public bool OnLeave()
            {
                return _service.OnLeave();
            }

            #endregion

            #region Implementation of IRibbonModuleAreaProvider

            public ObservableCollection<ICustomRibbonGroup> RibbonElements { get; private set; }
            public event PropertyChangedEventHandler RibbonElementsChanged;
            public void SendRibbonElementsChanged()
            {
            }
        ...
        private void BarButtonItem(object sender)
        {
            ...
            Dispatcher.CurrentDispatcher.BeginInvoke(DispatcherPriority.ContextIdle, new Action(() =>
            {
                ...
                try
                {
                    ...
                    if (instance == null)
                    {
                        var lowLevelInstance =
                        VisualMainWindow.ApplicationProxy.VisualModuleManager
                                        .CreateService<IVisualService>(
                                            mld.VisualServieMetadata.Descriptor);
                        if (lowLevelInstance == null)
                            return;

                        if (lowLevelInstance.OnEnter())
                        {
                            ...
                            SelectedModule = new LowLevelInstanceWrapper(lowLevelInstance);
                        }
                    }
        ...
        public void SetModule(string module)
        {
            ...
            ModuleLayoutDescriptor moduleLayoutDescriptor =
                moduleSorterService.GenerateDescriptor(
                    Application.VisualModuleManager.GetVisualServicesMetadata()
                               .FirstOrDefault(s => s.Descriptor == module));
